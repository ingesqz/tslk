...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="header-subtext" id="headerSubtext">Denne oversikten viser TS&LK's klubbrekorder gjennom tidene. Dataene er hentet fra medley.no og i tillegg er det lagt til noen eldre manuelle oppføringer som medley.no ikke har registrert. Tidene som vises på utøverene må være fra når de har svømt for TS&LK. Dersom noen mener at noe er feil, oppføringer som mangler etc. så send meg en mail på ingesqz@gmail.com så skal jeg få korrigert listene.</div>
        </div>
    </div>
    ...
    <script>
        ...
        const translations = {{
            no: {{
                ...
                headerSubtext: "Denne oversikten viser TS&LK's klubbrekorder gjennom tidene. Dataene er hentet fra medley.no og i tillegg er det lagt til noen eldre manuelle oppføringer som medley.no ikke har registrert. Tidene som vises på utøverene må være fra når de har svømt for TS&LK. Poeng er basert på FINA-2024. Dersom noen mener at noe er feil, oppføringer som mangler etc. så send meg en mail på ingesqz@gmail.com så skal jeg få korrigert listene.",
                eventLabel: "Øvelse:",
                genderLabel: "Kjønn:",
            ...
            en: {{
                ...
                headerSubtext: "This overview shows TS&LK's club records through time. The data is retrieved from medley.no and in addition some older manual entries that medley.no has not registered have been added. The times shown for the athletes must be from when they swam for TS&LK. Points are based on FINA-2024. If anyone thinks something is wrong, entries are missing etc. then send me an email at ingesqz@gmail.com and I will get the lists corrected.",
                eventLabel: "Event:",
                genderLabel: "Gender:",
        ...
        function changeLanguage(lang) {{
            ...
            document.getElementById('headerSubtext').textContent = translations[lang].headerSubtext;
